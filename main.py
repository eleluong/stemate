...
load_dotenv()
import gradio as gr
from src.utils import process_image_and_solve_with_progress
...
with gr.Blocks(css=custom_css, title="STEMMate") as demo:
    ...
    # Auto-solve when image is uploaded (optional)
    # image_input.change(
    #     fn=solve_with_progress,
    #     inputs=[image_input, enable_multi_model, selected_models],
    #     outputs=[question_output, steps_output, answer_output]
    # )
